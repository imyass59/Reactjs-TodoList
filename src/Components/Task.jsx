        ...
        <div className="flex flex-row items-center justify-between">
            <div id="info" className='flex flex-row items-center justify-between gap-4 text-3xl'>
                ...
                <div className='flex flex-col text-lg leading-none '>
                    <h1 className={(!props.completed)? "" : "text-[#50D890] line-through"}>{props.title}</h1>
                    <p className={(!props.completed)? "text-sm text-gray-400" : "text-sm text-[#50D890] line-through"}>{props.context}</p>
                </div>
            </div>
